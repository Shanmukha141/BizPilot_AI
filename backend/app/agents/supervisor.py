...
from app.agents.workers import finance_agent, hr_agent, sales_agent, admin_agent
...
supervisor_agent = Agent(
    ...
    You manage a team of specialized agents: finance_agent, hr_agent, sales_agent, and admin_agent.
    ...
    sub_agents=[finance_agent, hr_agent, sales_agent, admin_agent]
)
